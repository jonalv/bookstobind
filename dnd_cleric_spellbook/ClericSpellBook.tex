...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        %\includegraphics[height=1.1\pageheight]{spell_artwork/detect_evil_and_good.png}
        \texttt{Detect evil and good illustration}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        %\includegraphics[height=1.1\pageheight]{spell_artwork/guiding_bolt.png}
        \texttt{Guiding bolt illustration}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        %\includegraphics[height=1.1\pageheight]{spell_artwork/shield_of_faith.png}
        \texttt{Guardian of Faith illustration}
    };
\end{tikzpicture}
\newpage
