...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \includegraphics[height=1.1\pageheight]{spell_artwork/speak_with_dead.png}
    };
\end{tikzpicture}
\end{figure}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \includegraphics[height=1.1\pageheight]{spell_artwork/spirit_guardians.png}
    };
\end{tikzpicture}
\end{figure}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \includegraphics[height=1.1\pageheight]{spell_artwork/banishment.png}
    };
\end{tikzpicture}
\end{figure}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \includegraphics[height=1.1\pageheight]{spell_artwork/guardianoffaith.png}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \includegraphics[height=1.1\pageheight]{spell_artwork/commune.png}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \includegraphics[height=1.1\pageheight]{spell_artwork/holy_weapon.png}
    };
\end{tikzpicture}
\newpage
\section*{Holy Weapon}
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \includegraphics[height=1.1\pageheight]{spell_artwork/raise_dead.png}
    };
\end{tikzpicture}
\newpage
\section*{Raise Dead}
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \includegraphics[height=1.1\pageheight]{spell_artwork/astral_projection.png}
    };
\end{tikzpicture}
\end{figure}
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \includegraphics[height=1.1\pageheight]{spell_artwork/gate.png}
    };
\end{tikzpicture}
\newpage
\section*{Gate}
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \includegraphics[height=1.1\pageheight]{spell_artwork/mass_heal.png}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \includegraphics[height=1.1\pageheight]{spell_artwork/true_resurrection.png}
    };
\end{tikzpicture}
