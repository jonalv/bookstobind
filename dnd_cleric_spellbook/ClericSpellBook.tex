...
\makepagestyle{artimage}
\makeevenhead{artimage}{}{}{}
\makeoddhead{artimage}{}{}{}
\makeevenfoot{artimage}{\thepage}{}{}
\makeoddfoot{artimage}{}{}{\thepage}
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/light.png}}
    };
\end{tikzpicture}
\newpage
\section*{Light}
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/mending.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/toll_of_the_dead.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/bless.png}}
    };
\end{tikzpicture}
\newpage
\section*{Bless}
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/ceremony.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/cure_wounds.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/detectgoodandevil.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/guidingbolt.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/healing_word.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/shieldoffaith.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/aid.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/hold_person.png}}
    };
\end{tikzpicture}
\newpage
\section*{Hold Person}
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/Prayer_of_healing.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/spiritualweapon.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/animate_dead.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/bestow_curse.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/createfoodandwater.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/feign_death.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/speak_with_dead.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/spirit_guardians.png}}
    };
\end{tikzpicture}
\newpage
...
\vfill\vfill
\begin{center}
\includegraphics[width=1\textwidth]{spell_artwork/waterwalk.png}
\end{center}
\vfill
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/banishment.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/guardianoffaith.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/commune.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/holy_weapon.png}}
    };
\end{tikzpicture}
\newpage
\section*{Holy Weapon}
...
\vspace{1\baselineskip}\noindent
\lettrine[lines=4]{\includegraphics[height=56pt]{initials/S.png}}{\kern 1 pt warming, biting locusts} fill a 20-foot-radius sphere centered on a point you choose within range. The sphere spreads around corners. The sphere remains for the duration, and its area is lightly obscured. The sphere's area is difficult terrain. When the area appears, each creature in it must make a constitution saving throw. A creature takes 4d10 piercing damage on a failed save, or half as much damage on a successful one. A creature must also make this saving throw when it enters the spell's area for the first time on a turn or ends its turn there.
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/raise_dead.png}}
    };
\end{tikzpicture}
\newpage
\section*{Raise Dead}
...
\vfill\vfill
\begin{center}
\includegraphics[width=1\textwidth]{spell_artwork/scrying.png}
\end{center}
\vfill
...
\vfill\vfill
\begin{center}
\includegraphics[width=1\textwidth]{spell_artwork/createundead.png}
\end{center}
\vfill
...
\vfill\vfill
\begin{center}
\includegraphics[width=1\textwidth]{spell_artwork/earthquake.png}
\end{center}
\vfill
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/astral_projection.png}}
    };
\end{tikzpicture}
\end{figure}
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/gate.png}}
    };
\end{tikzpicture}
\newpage
\section*{Gate}
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/mass_heal.png}}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=center] at (current page.center) {
        \fbox{\includegraphics[height=0.85\pageheight]{spell_artwork/true_resurrection.png}}
    };
\end{tikzpicture}
\end{document}
